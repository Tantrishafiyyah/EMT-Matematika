...
\eulerheading{Sisipan Soal Individu}
\begin{eulercomment}
\end{eulercomment}
\begin{eulerprompt}
>function h(x) := 3*x+6;
...
\eulerheading{Sisipan soal Fungsi dalam 1 Parameter}
\begin{eulerprompt}
...
\eulerheading{Sisipan Soal Menggambar Beberapa Kurva dg Koordinat Sama}
\begin{eulerprompt}
...
\eulerheading{Sisipan Soal Plot Statistik}
\begin{eulercomment}
...
\eulerheading{Sisipan Soal Plot Logaritmik}
\begin{eulerprompt}
